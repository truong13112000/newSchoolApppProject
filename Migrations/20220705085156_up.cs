        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Taget_Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    C_User = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    D_Date = table.Column<DateTime>(type: "datetime2", nullable: true),
                    D_User = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ManageEntities", x => x.Key);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleGroup", x => new { x.GroupId, x.RoleId });
                    table.ForeignKey(
